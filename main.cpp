...
//    string token("1074139558:AAHPrCJFleoqGnMAYmO2aKldpLTbxvAtplc");
//    printf("Token: %s\n", token.c_str());
...
//        auto buttonGo = InlineKeyboardButton::Ptr(new InlineKeyboardButton);
//        buttonGo->text = "Go";
//        buttonGo->callbackData = "check";
//        auto buttonBack = InlineKeyboardButton::Ptr(new InlineKeyboardButton);
//        buttonBack->text = "Back";
//        buttonBack->callbackData = "check";
//        auto keyboardMarkup = InlineKeyboardMarkup::Ptr(new InlineKeyboardMarkup);
//        keyboardMarkup->inlineKeyboard.push_back({buttonGo, buttonBack});
//        bot.getApi().sendMessage(message->chat->id, "Game message", false, 0, keyboardMarkup, "Markdown");
//    });
